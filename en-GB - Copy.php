...
define('_JOMRES_COM_MR_GENERALCONFIGDESC','Equipment Configuration');
...
define('_JOMRES_COM_MR_NEWPROPERTY','New equipment');
define('_JOMRES_COM_MR_NEWPROPERTYFEATURE','New equipment feature');
define('_JOMRES_COM_MR_NEWGUEST','New guest');
define('_JOMRES_COM_MR_SAVE','Save');
define('_JOMRES_COM_MR_VIEWBOOKINGS_SURNAME','Name');
define('_JOMRES_COM_MR_VIEWBOOKINGS_ARRIVAL','Pickup');
define('_JOMRES_COM_MR_VIEWBOOKINGS_DEPARTURE','Return');
...
define('_JOMRES_COM_MR_ASSIGNUSER_AUTHORISEDDEFAULTHOTEL','Default equipment');
...
define('_JOMRES_COM_MR_ASSIGNUSER_LEVEL_ADMIN','rental manager');
...
define('_JOMRES_COM_MR_EDITBOOKING_TAB_ROOM','Equipment');
...
define('_JOMRES_COM_MR_EB_ROOM_NAME','Equipment name');
define('_JOMRES_COM_MR_EB_ROOM_NUMBER','Equipment');
...
define('_JOMRES_COM_MR_EB_ROOM_CLASS_ABBV','Equipment type');
define('_JOMRES_COM_MR_EB_ROOM_CLASS_DESC','Equipment type description');
define('_JOMRES_COM_MR_EB_ROOM_FEATURES_LIST','Equipment features list');
...
define('_JOMRES_COM_MR_QUICKRES_STEP2_TITLE','Our equipment');
define('_JOMRES_COM_MR_QUICKRES_STEP2_PROPERTYNAME','Equipment');
define('_JOMRES_COM_MR_QUICKRES_STEP2_ROOMTYPE','Equipment type');
...
define('_JOMRES_COM_MR_QUICKRES_STEP4_STAYDAYS','Days');
...
define('_JOMRES_COM_MR_VIEWROOMSPROPERTYCONFIG_TITLE','View resources and fees');
define('_JOMRES_COM_MR_VRCT_TAB_ROOM','Equipment');
define('_JOMRES_COM_MR_VRCT_TAB_ROOMFEATURES','Rm features');
define('_JOMRES_COM_MR_VRCT_TAB_ROOMTYPES','Rm types');
define('_JOMRES_COM_MR_VRCT_TAB_PROPERTYS','Equipment');
define('_JOMRES_COM_MR_VRCT_TAB_PROPERTYFEATURES','Prop feats');
define('_JOMRES_COM_MR_VRCT_ROOM_HEADER_LINK','Equipment');
...
define('_JOMRES_COM_MR_VRCT_ROOM_SAVE_INSERT','Equipment added');
...
define('_JOMRES_COM_MR_VRCT_ROOMFEATURES_SAVE_INSERT','Equipment feature added');
define('_JOMRES_COM_MR_VRCT_ROOMFEATURES_SAVE_UPDATE','Equipment feature updated');
define('_JOMRES_COM_MR_VRCT_ROOMTYPES_HEADER_LINK','Equipment type');
define('_JOMRES_COM_MR_VRCT_ROOMTYPES_HEADER_ABBV','Equipment type abbreviation');
define('_JOMRES_COM_MR_VRCT_ROOMTYPES_HEADER_DESC','Equipment type description');
define('_JOMRES_COM_MR_VRCT_ROOMTYPES_SAVE_INSERT','Equipment type added');
define('_JOMRES_COM_MR_VRCT_ROOMTYPES_SAVE_UPDATE','Equipment type updated');
...
define('_JOMRES_COM_MR_VRCT_PROPERTY_SAVE_INSERT','Equipment added');
define('_JOMRES_COM_MR_VRCT_PROPERTY_SAVE_UPDATE','Equipment updated');
define('_JOMRES_COM_MR_VRCT_PROPERTYFEATURES_HEADER_LINK','Equipment Features');
define('_JOMRES_COM_MR_VRCT_PROPERTYFEATURES_ABBV','Equipment feature abbv.');
define('_JOMRES_COM_MR_VRCT_PROPERTYFEATURES_HEADER_DESC','Equipment feature full description');
define('_JOMRES_COM_MR_VRCT_PROPERTYFEATURES_SAVE_INSERT','Equipment feature added');
define('_JOMRES_COM_MR_VRCT_PROPERTYFEATURES_SAVE_UPDATE','Equipment feature updated');
define('_JOMRES_COM_MR_LISTTARIFF_TITLE','Fees');
define('_JOMRES_COM_MR_LISTTARIFF_RATETITLE','fee title');
...
define('_JOMRES_COM_MR_LISTTARIFF_ROOMRATEPERDAY','Rate per day');
...
define('_JOMRES_COM_MR_LISTTARIFF_ROOMCLASS','Equipment type');
define('_JOMRES_COM_MR_LISTTARIFF_IGNOREPPN','Ignore PPPN');
define('_JOMRES_COM_MR_LISTTARIFF_ALLOWWE','Allow weekends');
define('_JOMRES_COM_MR_LISTTARIFF_SAVE_INSERT','fee added');
define('_JOMRES_COM_MR_LISTTARIFF_SAVE_UPDATE','fee updated');
define('_JOMRES_COM_MR_LISTTARIFF_LINKTEXT','Edit item');
define('_JOMRES_COM_MR_LISTTARIFF_LINKTEXTCLONE','Clone item');
define('_JOMRES_COM_MR_LISTTARIFF_DELETED','fee deleted');
define('_JOMRES_COM_MR_LISTTARIFF_TITLE_EDIT','Edit fee');
...
define('_JOMRES_FRONT_MR_MENU_ADMIN_PROPERTYADMIN','Equipment admin');
...
define('_JOMRES_FRONT_MR_QUICKRES_STEP2_NOROOMSINRANGE','There are no equipments available able to satisfy the parameters specified');
...
define('_JOMRES_FRONT_MR_EMAIL_SUBJECT_INTERNETBOOKINGMADE','Rental made for equipment: ');
define('_JOMRES_FRONT_MR_EMAIL_TEXT_ROOM','Rental made for equipment: ');
define('_JOMRES_FRONT_MR_EMAIL_TEXT_ARRIVAL','Pickup: ');
define('_JOMRES_FRONT_MR_EMAIL_TEXT_DEPARTURE','Return: ');
...
define('_JOMRES_COM_A_TARIFFS','Fees & Currency');
...
define('_JOMRES_COM_A_TARIFFS_PER_DESC','Select Yes if you want to charge per-person-per-night. If no, then costs will be calculated on a per-rental-per-night basis');
define('_JOMRES_COM_A_UPLOADS_FILESIZE','File size');
define('_JOMRES_COM_A_UPLOADS_FILESIZE_DESC','Max. Image Filesize in Kilobyte');
define('_JOMRES_FRONT_MR_BOOKED','Equipments rented');
define('_JOMRES_COM_CONFIRMATION_TITLE','Confirmation letter');
define('_JOMRES_COM_CONFIRMATION_DEAR','Dear ');
define('_JOMRES_COM_CONFIRMATION_RATE_RULES','Cost per night - per equipment ');
...
define('_JOMRES_COM_CONFIRMATION_RESERVATION_CHECKIN','Your equipment will be held until your arrival, and check in is after 2pm.');
...
define('_JOMRES_COM_CONFIRMATION_RESERVATION_SMALLPRINT_NOALLOWANCE','No allowance can be made for meals not taken or for equipments not occupied for the full period of the rental. With this in mind we strongly recommend that you use a holiday insurance facility.');
...
define('_JOMRES_COM_CONFIRMATION_RESERVATION_VAT','VAT@ 17.5% is included in all fees. Any increase or alterations will be charged.');
...
define('_JOMRES_COM_MR_ROOM_UNABLETODELETE','Unable to remove this equipment, there are rentals against it. Cancel those rentals then retry.');
define('_JOMRES_COM_MR_ROOM_DELETED','Equipment deleted');
define('_JOMRES_COM_MR_ROOMFEATURE_DELETE','Delete equipment feature');
define('_JOMRES_COM_MR_ROOMFEATURE_UNABLETODELETE','Unable to remove this equipment feature, it is assigned to a equipment or equipments. Remove the feature from those equipments and retry.');
define('_JOMRES_COM_MR_ROOMFEATURE_DELETED','Equipment feature deleted');
define('_JOMRES_COM_MR_PROPERTYFEATURE_DELETE','Delete equipment feature');
define('_JOMRES_COM_MR_PROPERTYFEATURE_UNABLETODELETE','Unable to remove this equipment feature, it is assigned to a equipment. Remove the feature from this equipment and retry.');
define('_JOMRES_COM_MR_PROPERTYFEATURE_DELETED','Equipment feature deleted');
define('_JOMRES_COM_MR_ROOMCLASS_DELETE','Delete equipment type');
define('_JOMRES_COM_MR_ROOMCLASS_UNABLETODELETE_ROOMS','Unable to remove this equipment type, it is assigned to a equipment. Try re-assigning the equipment to another equipment type then try again.');
define('_JOMRES_COM_MR_ROOMCLASS_UNABLETODELETE_TARIFFS','Unable to remove this equipment type, it is assigned to a fee. Try re-assigning the fee to another equipment type then try again.');
define('_JOMRES_COM_MR_ROOMCLASS_DELETED','Equipment type deleted');
define('_JOMRES_COM_MR_PROPERTY_DELETE','Delete equipment');
define('_JOMRES_COM_MR_PROPERTY_DELETED','Equipment deleted');
define('_JOMRES_COM_MR_PROPERTY_DELETE_NORIGHTS','You do not have rights to delete this rental.');
...
define('_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_PROPDESCRIPTION','Equipment description');
...
define('_JOMRES_COM_A_VISITORSCANBOOKONLINE_DESC','Set this to Yes to ensure that visitors can rent rentals online.');
...
define('_JOMRES_COM_A_BOOKING','Rental equipments');
...
define('_JOMRES_COM_A_SINGLEROOMPROPERTY_DESC','EG you are renting out a equipment, rather than equipments in that equipment. If this is the case, then you must make sure that you only have the one equipment registered against each equipment.');
...
define('_JOMRES_COM_AVLCAL_INBGCOLOUR','Cell bgcolour for days when equipment is available');
...
define('_JOMRES_COM_AVLCAL_PROVISIONALCOLOUR','Cell bgcolour for provisionally rented equipments (rentals for which a deposit has not been taken)');
...
define('_JOMRES_FRONT_DELETEGUEST_UNABLETODELETEGUEST','Unable to delete this guest as they have rentals open against them with another equipment.');
define('_JOMRES_COM_INVOICE_ACTUALROOMCOST','Actual equipment cost: ');
...
define('_JOMRES_MR_AUDIT_INSERT_ROOM','Created equipment');
define('_JOMRES_MR_AUDIT_UPDATE_ROOM','Updated equipment');
define('_JOMRES_MR_AUDIT_DELETE_ROOM','Deleted equipment');
define('_JOMRES_MR_AUDIT_INSERT_ROOM_FEATURE','Created equipmentfeature');
define('_JOMRES_MR_AUDIT_UPDATE_ROOM_FEATURE','Updated equipmentfeature');
define('_JOMRES_MR_AUDIT_DELETE_ROOM_FEATURE','Deleted equipmentfeature');
define('_JOMRES_MR_AUDIT_INSERT_ROOM_TYPE','Inserted equipmenttype');
define('_JOMRES_MR_AUDIT_UPDATE_ROOM_TYPE','Updated equipmenttype');
define('_JOMRES_MR_AUDIT_DELETE_ROOM_TYPE','Deleted equipmenttype');
define('_JOMRES_MR_AUDIT_INSERT_PROPERTY','Created equipment');
define('_JOMRES_MR_AUDIT_UPDATE_PROPERTY','Updated equipment');
define('_JOMRES_MR_AUDIT_DELETE_PROPERTY','Deleted equipment');
...
define('_JOMRES_MR_AUDIT_INSERT_TARIFF','Created fee');
define('_JOMRES_MR_AUDIT_UPDATE_TARIFF','Updated fee');
define('_JOMRES_MR_AUDIT_DELETE_TARIFF','Deleted fee');
...
define('_JOMRES_MR_AUDIT_BOOKED_ROOM','Rented a equipment');
...
define('_JOMRES_FRONT_MR_MENU_ADMIN_BLACKBOOKINGS_STAGE2_ERROR','There was an error attempting to rent these equipments, one or more of the equipments you selected is not free.');
define('_JOMRES_FRONT_MR_MENU_ADMIN_BLACKBOOKINGS_ROOMSSUBJECT','Equipments included in black rental');
...
define('_JOMRES_COM_A_ROOMTAX','Equipment tax');
define('_JOMRES_COM_A_ROOMTAX_DESC','Designed for the American market. These are the equipment tax amounts that will be charged to the guest. You can charge a combination and/or of fixed and percentage figures. Note that these taxes are only applied to the cost of the equipment.');
...
define('_JOMRES_FRONT_TARIFFS','Our fees');
define('_JOMRES_FRONT_TARIFFS_TITLE','Fee name');
define('_JOMRES_FRONT_TARIFFS_DESC','Fee description');
define('_JOMRES_FRONT_TARIFFS_ROOMTYPE','Equipment type');
...
define('_JOMRES_FRONT_TARIFFS_PN','Per day');
...
define('_JOMRES_FRONT_PTYPE','Equipment type');
define('_JOMRES_COM_PTYPES_LIST_TITLE','List equipment types');
define('_JOMRES_COM_PTYPES_LIST_TITLE_EDIT','Edit equipment type');
define('_JOMRES_COM_PTYPES_PTYPE','Equipment type');
define('_JOMRES_COM_PTYPES_SAVED','Equipment type saved');
define('_JOMRES_COM_PTYPES_UNABLETO_DELETE','Unable to delete equipment type. Equipment type is assigned to one or more rentals, please re-assign them before trying to delete');
define('_JOMRES_COM_PTYPES_DELETED','Equipment type(s) deleted');
...
define('_JOMRES_COM_MONTHSTOSHOW_DESC','In the equipment availability, How many months of the calendar should be shown?');
...
<br/> 
Choose the equipment(s) you wish to take out of service. <br>If a equipment does not have a check mark against it, it cannot be included in the black rental until any outstanding rentals have been completed/cancelled.<br/> ');
...
define('_JOMRES_FRONT_GALLERYLINK','View this equipment\'s website');
...
define('_JOMRES_MR_CREDITCARD_EDIT','Edit credit carrentald');
define('_JOMRES_COM_A_EDITICON','Edit icon size');
define('_JOMRES_JR_A_IMAGEHANDLING_BATCHUPLOAD','Batch equipment image upload');
...
define('_JOMRES_COM_A_SLIDESHOWS_NOIMAGES','<br />Sorry, no images available for this equipment. Please upload some images using the batch upload feature if you wish to use the slideshow feature.');
define('_JOMRES_COM_A_TARIFFS_SHOWTARIFFSLINK','Show link to fees?');
...
define('_JOMRES_FRONT_IMAGEUPLOADS_INFO','Use this form to upload multiple images of this equipment.<br/><b>Note</b> that any images with the same name will be overwritten. Also note that this form does not upload equipment specific images or the equipment header image, you will need to upload them from the Equipment Admin section.<br/><b>Note</b> Images uploaded here will be written to the /jomres/uploadedimages/*equipment_uid* folder. If this folder does not exist, it will be created, unless of course an alternative directory has been specified in the configuration.');
define('_JOMRES_A_TABS_MISC','Misc');
define('_JOMRES_A','Site configuration');
define('_JOMRES_A_GLOBALPFEATURES','Use global equipment features');
define('_JOMRES_A_GLOBALPFEATURES_DESC','Set this to Yes if you want to force all equipment to use only the equipment features defined by the webmaster.');
define('_JOMRES_A_GLOBALPFEATURES_INFO','To assign an image to this feature you first need to upload your equipment feature images to the /jomres/uploadedimages/pfeatures/ folder. ');
...
define('_JOMRES_FRONT_MR_MENU_BOOKAROOM','Rent now');
define('_JOMRES_FRONT_MR_MENU_BOOKTHISPROPERTY','Rent now');
define('_JOMRES_COM_MR_DISPGUEST_CCV','Security number');
define('_JOMRES_COM_A_TARIFFS_SHOWTARIFFSINLINE','Show fees inline?');
...
define('_JOMRES_COM_A_BASICTEMPLATE_SHOWROOMS','Click for equipments and availability');
define('_JOMRES_COM_A_BASICTEMPLATE_SHOWTARIFFS','Show fees information');
define('_JOMRES_COM_A_BASICTEMPLATE_SHOWADDRESS_TITLE','Show Address information below this link');
define('_JOMRES_COM_A_BASICTEMPLATE_SHOWDETAILS_TITLE','Show detailed equipment info below this link');
define('_JOMRES_COM_A_BASICTEMPLATE_SHOWROOMS_TITLE','Show equipments and availability below this link');
define('_JOMRES_COM_A_BASICTEMPLATE_SHOWTARIFFS_TITLE','Show fee information below this link');
define('_JOMRES_COM_A_TARIFFS_MODEL_SINGLETARIFF','Flat rate fees');
define('_JOMRES_COM_A_TARIFFS_MODEL_AVERAGES','Averages');
define('_JOMRES_COM_A_TARIFFS_MODEL','Select the fees model you want to use');
define('_JOMRES_COM_A_TARIFFS_MODEL_DESC',"You have two choices of fee calculation methods. The first, the 'flat rate' method allows you to offer a number of different fees to the guest and the rate for the stay is the same for the entire time. This is useful if you want to offer several different fees for the same date, eg Bed and Breakfast fee and B&B and Evening meal fee. Choose the 'averages' fee if you want to adjust your prices dependant on the date in question. Jomres will find all of the fees for each day in the rental, add them together then return the average rate across the period");
...
define('_JOMRES_COM_PROPERTYLISTDESC_DESC',"This limits the number of characters shown in the equipment listing when drawing from the equipment description.");
...
define('_JOMRES_A_GLOBALROOMTYPES','Use global equipment types');
define('_JOMRES_A_GLOBALROOMTYPES_DESC','Set this to Yes if you want to force all equipments to use only the equipment types defined by the webmaster. You need to set this to Yes if you intend to allow searching via equipment types.');
define('_JOMRES_A_GLOBALROOMTYPES_INFO','To assign an image to this equipment type you first need to upload your equipment type images to the /images/stories/jomres/rmtypes/ folder. ');
...
define('_JOMRES_COM_SELFREGISTRATION','Users can register their rentals?');
define('_JOMRES_COM_SELFREGISTRATION_DESC','Set this to Yes if you want users to be able to register their own equipments without admin intervention.');
define('_JOMRES_REGISTRATION_INSTRUCTIONS_STEP1','Please provide the country and region of your rental.');
define('_JOMRES_REGISTRATION_INSTRUCTIONS_STEP2_1','Please complete your equipment details.');
define('_JOMRES_REGISTRATION_INSTRUCTIONS_STEP2_2','Items highlighted are required.');
define('_JOMRES_REGISTRATION_AUDIT_CREATEPROPERTY','Created rental');
define('_JOMRES_REGISTRATION_NOTALLOWED',"Sorry, you can't create a equipment on this system. You must be a logged in, registered user before you can proceed.");
define('_JOMRES_REGISTRATION_CREATEDPROPERTY','Created equipment: ');
...
define('_JOMRES_NUMBEROFROOMSAVAILABLE','Number of equipments available');
define('_JOMRES_BACKTOPROPERTYDETAILSLINK','Back to quipment details');
define('_JOMRES_FRONT_ROOMTYPES','Equipment types');
define('_JOMRES_A_GLOBAL_SEARCHOPTION_RANDOMLIMIT','Random search limit');
define('_JOMRES_SHOWGOOGLECURRENCYLINKS','Show currency conversion links in fee listing?');
...
define('_JOMRES_AJAXFORM_INSTRUCTIONS','Use this form to place your rental. Modify your rental particulars like arrival and departure dates & guest numbers, then select the equipment(s) you require from the list of those available. Click any available equipments to add them to your rental. When done, you can add any optional extras you may require and provide your address details. When the form has enough information it will then give you a submit button so that you can confirm your rental.');
...
define('_JOMRES_AJAXFORM_AVAILABLE_DESC','Select the equipments that you require');
define('_JOMRES_AJAXFORM_AVAILABLE_DESC_SRP','Look here to see if the equipment is available at this time.');
define('_JOMRES_AJAXFORM_EXTRAS','Extra Addon');
define('_JOMRES_AJAXFORM_EXTRAS_DESC','Extras');
...
define('_JOMRES_AJAXFORM_AVAILABLEROOMS','Available equipments');
define('_JOMRES_AJAXFORM_SELECTEDROOMS','Selected equipments');
...
define('_JOMRES_VARIANCES_ISPERCENTAGE_TT','The figure calculated is a percentage of the Base figure calculated for the equipment. If this is set to no then the figure you specify is simply added or subtracted from the base equipment value.');
define('_JOMRES_VARIANCES_POSNEG','Add variance?');
define('_JOMRES_VARIANCES_POSNEG_TT','The figure calculated is added to or removed from the Base figure calculated for the equipment. Set this to No if you want this to be a discount from the base figure. ');
...
define('_JOMRES_COM_A_SHOWROOMSLISTLINK','Show link to equipments list page in equipment details page?');
define('_JOMRES_COM_A_SHOWONLYAVLCAL','Show <b>only</b> Availability calendar?');
define('_JOMRES_COM_A_SHOWONLYAVLCAL_DESC','Switch this to Yes to disable display of the equipment header and details, so that only the availability calendar is viewable in the equipment details section. Only really intended for users renting out single equipment equipments (eg apartments, cottages etc).');
...
define('_JOMRES_COM_A_BOOKINGFORM_SHOWROOMNO','Rental form equipment list show equipment number');
define('_JOMRES_COM_A_BOOKINGFORM_SHOWROOMNAME','Rental form equipment list show equipment name');
define('_JOMRES_COM_A_BOOKINGFORM_SHOWTARIFFTITLE','Rental form equipment list show fee title');
...
define('_JOMRES_COM_AVLCAL_BOOKING_KEY','Equipment is rented');
...
define('_JOMRES_COM_A_TARIFFPRICESAREWEEKLY','fee charges stored as weekly figures?');
define('_JOMRES_COM_A_TARIFFPRICESAREWEEKLY_DESC','You have the option of storing fee charges in either daily or weekly values. If storing them as weekly, you MUST set this option to Yes.');
...
define('_JOMRES_BOOKINGFORM_MONITORING_TOO_MANY_IN_PARTY_FOR_TARIFFS','You have too many in the party for the available fees');
define('_JOMRES_BOOKINGFORM_MONITORING_MORE_ROOMS_THAN_GUESTS','You have chosen more equipments than you have guests, click on a equipment name to remove it from your selection');
define('_JOMRES_BOOKINGFORM_MONITORING_TOO_MANY_GUESTS_FOR_BEDS','Too many guests for the available beds');
define('_JOMRES_BOOKINGFORM_MONITORING_CHOOSE_MORE_ROOMS','You need to choose more equipments');
define('_JOMRES_BOOKINGFORM_MONITORING_SELECT_A_ROOM','Select a equipment');
...
define('_JOMRES_BOOKINGFORM_NOROOMSSELECTEDYET','No equipments selected yet');
...
define('_JOMRES_COM_LIMITROOMSLIST','Available equipments/fee limit');
define('_JOMRES_COM_LIMITROOMSLIST_DESC','Use this input to limit the number of available equipments & fees that are listed in the rental form. Set it to zero if you do not want limiting enabled. ');
...
define('_JOMRES_COM_JRCONFIG_GLOBALEDITING_DESC','Take care with this function. If set to Yes, then the editing mode will affect the custom text for ALL equipments in the system for the constant you are editing.');
define('_JOMRES_COM_JRCONFIG_GLOBALCURRENCYYESNO','Use global currency?');
define('_JOMRES_COM_JRCONFIG_GLOBALCURRENCYYESNO_DESC','Set this to yes to force all equipments to use the same currency (e.g. & # 8 3 6 4 ;)');
...
define('_JOMRES_COM_USERIS_SUPERPROPERTYMANAGER','Super Equipment Manager');
define('_JOMRES_COM_WEEKENDONLY','Weekends only');
define('_JOMRES_COM_WEEKENDDAYS','Weekend days');
define('_JOMRES_COM_WEEKENDDAYS_DESC','Set your weekend days. fees that allow or disallow weekends will take this setting into account when generating the equipments list.');
define('_JOMRES_EDITPROPERTY_SELECTCOUNTRY','Select your country before adding any equipment information');
define('_JOMRES_EDITPROPERTY_SAVEBEFOREUPLOAD','Save your equipment changes before uploading a equipment image');
...
define('_JOMRES_SEARCH_AVL_INFO','Please enter your intended pickup and return dates and press the button to find equipments that have accommodation available on your chosen dates.');
define('_JOMRES_SEARCH_PTYPES','List all equipments by equipment type.');
define('_JOMRES_SEARCH_RTYPES','List all equipments by equipments type.');
define('_JOMRES_SORTORDER_DEFAULT','Default');
define('_JOMRES_SORTORDER_PROPERTYNAME','Equipment Name');
define('_JOMRES_SORTORDER_PROPERTYREGION','Equipment Region');
define('_JOMRES_SORTORDER_PROPERTYTOWN','Equipment Town');
define('_JOMRES_SORTORDER_STARS','Stars');
define('_JOMRES_PATHWAY_PROPERTYLIST','Equipment list');
define('_JOMRES_PATHWAY_PROPERTYDETAILS','Equipment details ');
...
define('_JOMRES_BOOKINGFORM_BLOCKUIMESSAGES_CHANGINGROOMSELECTION','Changing your equipment selection');
...
define('_JOMRES_COM_A_BOOKINGFORM_SHOWROOMIMAGE','Equipment image');
...
define('JOMRES_COM_A_TARIFFMODE','fee Configuration Mode');
define('JOMRES_COM_A_TARIFFMODE_DESC',"<b>Warning: Switching between different fee types may result in loss of data. See the note below regarding this</b>.
<br/><br/>
You have three options as to how you configure your fees.<br/>
Normal mode: You will have one fee for each equipment type that is valid for the next 10 years.<br/>
Micromanage: You can modify the price for each and every day for each equipment type. <br/>
Advanced: The \"old\" Jomres method of managing fees. <br/>
<br/>
The different fee modes allow you to choose the method of configuring fees that suits you best.<br/>
Normal mode is the most simplistic but it's the easiest to understand because it will cross reference equipments and fees to equipment types and allows you to configure equipments and prices on the same page.<br/>
Micro manage allows you to vary the rates on a day to day basis without having to manage reams of fees, it is done by cross referencing lots of different fees with each other. This results in a number of fees being created for you covering a period of time, but you can not layer fees over each other.<br/>
Advanced mode lets you create a equipment and associate it with a equipment type. You then create a fee and associate THAT with a equipment type. Using this method it is possible to \"layer\" fees over each other, for example a equipment type \"Double bed\" can have one fee for bed and breakfast, and another for bed, breakfast and evening meal. The advanced method requires a little more attention to detail because it is possible to dis-associate a equipment or fee from a equipment type, or to incorrectly set valid from and to dates, but it does give you configuration options that the other modes do not offer. <br/>
<br/>
Because Normal and Micromanage modes require a specific set up of equipments and fees for the fee mode to work the system may need to reset some data to make the current fee configurations compatible with the current fee editing mode.<br/>
<br/>
Normal -> Advanced. No change. Existing fees are retained.<br/>
Normal -> Micromanage. All existing fees are removed.<br/>
Advanced -> Normal. All existing fees are removed.<br/>
Advanced -> Micromanage. All existing fees are removed.<br/>
Micromanage -> Advanced. All existing cross references between fees are removed, but the fees themselves will remain.<br/>
Micromanage -> Normal. All existing cross references and fees are removed.<br/>");
define('_JOMRES_COM_A_LISTROOMSINPROPERTYDETAILS','Show equipments list in equipment details page?');
define('JOMRES_PROPERTYTYPE','Equipment type');
define('JOMRES_COM_A_SRPONLY','SRP only');
define('JOMRES_MAXPEOPLEINROOM','Max people per equipment');
...
define('_JOMCOMP_MYUSER_PROPERTYTYPE','Equipment type');
define('_JOMCOMP_MYUSER_PUBLISHEDPROPERTIES','Equipments on site');
define('_JOMCOMP_WISEPRICE_TITLE','Wise price');
define('_JOMCOMP_WISEPRICE_ACTIVE','Active');
define('_JOMCOMP_WISEPRICE_TITLE_DESC','This plugin allows you to enable and configure your equipment prices dynamically.');
define('_JOMCOMP_WISEPRICE_TITLE_DESC_FULL','Most equipments will recalculate equipment prices based on the number of equipments of a required type that are available on a given date. This allows them to offer discounts on a equipment type that isn\'t busy during a given period with the aim of attracting equipment that might otherwise be missed.<br/>Enabling and configuring this plugin allows you to offer adjustable pricing based on the number of equipments of a selected type are available in the equipment on a given day.<br/> The days threshold defines the number of days that the arrival date must be within before rental prices are adjusted by this feature, then the percentages options allow you to configure the percentage of equipments that can be available before a given discount is applied. Note however, if multiple equipments are rented then the current level of discount will be applied to all equipments and will not reduce as more equipments are selected.');
define('_JOMCOMP_WISEPRICE_THREASHOLD','Threshold (number of days between arrival date and today)');
define('_JOMCOMP_WISEPRICE_PERCENTAGE10','Percentage equipments occupied 10% or less');
define('_JOMCOMP_WISEPRICE_PERCENTAGE25','Percentage equipments occupied 25% or less');
define('_JOMCOMP_WISEPRICE_PERCENTAGE50','Percentage equipments occupied 50% or less');
define('_JOMCOMP_WISEPRICE_PERCENTAGE75','Percentage equipments occupied 75% or less');
...
define('JOMRES_COM_A_MAPSKEY_DESC','Get can get a google maps API key from <a href="http://www.google.com/apis/maps/signup.html" target="_blank">Google maps</a>. Once you have input your map key here, Jomres will show the map in your Equipment Details page.');
...
define('JOMRES_COM_A_VERBOSETARIFFINTO','Verbose fee info');
define('JOMRES_COM_A_VERBOSETARIFFINTO_DESC','Set this to Yes to show more detailed fee information in the equipment details/fee popup');
define('JOMRES_COM_A_MINIMALCONFIG','Minimise configuration options');
define('_JOMCOMP_AMEND','Amend Rental - Equipment Selection');
define('_JOMCOMP_AMEND_SELECTPROPERTY','Select New Equipment');
...
define('_JRPORTAL_CONFIG_DEFAULT_CRATE_DESC','Choose the default commission rate that will be applied to a equipment in the event that another commission rate is not otherwise set.');
...
define('_JRPORTAL_CPANEL_LISTPROPERTIES','List Equipment');
define('_JRPORTAL_PROPERTIES_PROPERTYNAME','Equipment name');
define('_JRPORTAL_PROPERTIES_PROPERTYADDRESS','Equipment address');
define('_JRPORTAL_PROPERTIES_LEGEND','Equipments who\'s background colour is red have not yet had a commission rate applied to them.');
define('_JRPORTAL_STATS_PATETITLE','Statistics');
define('_JRPORTAL_STATS_STATTYPE','Statistics for: ');
define('_JRPORTAL_STATS_STATTYPE_PROPERTIES','Equipments - Clicks');
define('_JRPORTAL_PROPERTIES_VIEWPROPERTY','Equipment view');
...
define('_JRPORTAL_LISTBOOKINGS_HEADER_PROPERTY_ID','Equipment id');
...
define('_JRPORTAL_ADD_ADHOC_ITEM_CHOOSEPROPERTY','Associated equipment (if applicable)');
...
define('_JOMRES_COM_PTYPES_PTYPE_DESC_FURTHER','You can have equipment type specific language files by setting the description to the name of a sub folder, e.g. "yachtbrokerage" and copying a language file to that subfolder. You can then modify that language file for this equipment type so equipments become, for example, DVDs, etc.');
define('_JOMRES_EDITPROPERTY_CONNOTDELETE1','You cannot delete this equipment as it is the only equipment that you have access to. If you want to disable it, please use the un-publish feature in your toolbar. ');
define('_JOMRES_EDITPROPERTY_CONNOTDELETE2','If this is a demo installation and you intend to upgrade to Jomres Solo (one equipment only limit) then you should create a new equipment first, then delete this one before changing your license key to the Solo license key that you will be assigned on purchase. ');
...
define('_JOMRES_COM_ISTHISANMRP',"Is this equipment a hotel/bed and breakfast/guest house/pension? ");
define('_JOMRES_COM_ISTHISANMRP_DESC',"Configuration options differ depending on if you are renting out equipments in a equipment, or the equipment itself. Select MRP if you are offering equipments, select SRP if you are offering the entire equipment. ");
...
define('_JOMRES_AJAXFORM_ACCOMMODATION_TOTAL',"Rental Total");
define('_JOMRES_AJAXFORM_ACCOMMODATION_NIGHTS',"night(s) at");
define('_JOMRES_AJAXFORM_ACCOMMODATION_PERROOM',"per equipment ");
define('_JOMRES_AJAXFORM_EXTRAS_TOTAL',"Extras");
...
define('_JOMRES_FRONT_MR_MENU_CONTACTHOTEL','Contact Business');
define('_JOMRES_FRONT_MR_MENU_CONTACTHOTEL_SUBJECT','Equipment enquiry from ');
define('_JOMRES_FRONT_MR_MENU_CONTACTHOTEL_THANKS','Thank you for your enquiry, your message has been sent to the equipment\'s contact email address, and copied to your own address for your records. They will respond to you as soon as possible with their reply.');
...
define('_JOMRES_BOOKINGFORM_LOOKRIGHT','Please select your required accommodation from the list below by clicking on the equipment.');
define('_JOMRES_COM_MR_EB_ROOM_MINROOMS','Min equipments already selected');
define('_JOMRES_COM_MR_EB_ROOM_MINROOMS_DESC','Minimum number of equipments already selected in rental before fee/equipment type combo can be offered. Allows you to have discounted fees when more than N equipments are already selected. ');
define('_JOMRES_COM_MR_EB_ROOM_MAXROOMS','Max equipments already selected');
define('_JOMRES_COM_MR_EB_ROOM_MAXROOMS_DESC','Maximum number of equipments already selected in rental before fee/equipment combo is no longer offered. Allows you to stop offering this equipment type/fee combination once N equipments have been selected in the rental form. ');
...
define('_JOMRES_COM_SEF_TASK_ALIAS_VIEWPROPERTY','View equipment task alias');
...
define('_JOMRES_COM_SEF_PROPERTY_URL_PTYPE','Add equipment type to url');
define('_JOMRES_COM_SEF_PROPERTY_URL_PTYPE_DESC','');
define('_JOMRES_COM_SEF_PROPERTY_URL_PROPERTYNAME','Add equipment name to url');
define('_JOMRES_COM_SEF_PROPERTY_URL_PROPERTYNAME_DESC','');
define('_JOMRES_COM_SEF_PROPERTY_URL_PROPERTY_ID','Append equipment id to equipment name');
define('_JOMRES_COM_SEF_PROPERTY_URL_PROPERTY_ID_DESC','if equipment name is set to No then the id will not be used. If set to yes then the url will look like fawlty_towers-1');
...
define('_JOMRES_COM_SEF_DEFAULT_COUNTRY_DESC','If all your equipmentls are in one country then you will not have country in the search - enter a default country here if you want to display a country');
...
define('_JOMRES_COM_SEF_DEFAULT_REGION_DESC','If all your equipmentls are in one region then you will not have region in the search - enter a default region here if you want to display a region');
...
define('_JOMRES_COM_SEF_SEARCH_URL_PTYPE','Search URL Structure - equipment type');
define('_JOMRES_COM_SEF_SEARCH_URL_PTYPE_DESC','');
define('_JOMRES_COM_SEF_DEFAULT_PTYPE','Search URL Structure - Default equipment type');
define('_JOMRES_COM_SEF_DEFAULT_PTYPE_DESC','Used in url if search is for all equipment types');
...
define('_JOMRES_CUSTOMTEXT_EXTRAMODEL_PERDAYSPERROOM','Per days X equipments selected');
...
define('_JOMRES_COM_COMPOSITE_PROPERTY_DETAILS','Use Composite Equipment Details?');
define('_JOMRES_COM_COMPOSITE_PROPERTY_DETAILS_DESC','Jomres 3.3 introduces the composite equipment details where all of the equipment details output is sent to one template file (composite_equipment_details.html). If you do not wish to use this set it to No (only existing users are expected to set this to No, new users will probably want to leave it set to Yes)');
define('_JOMRES_PROFILELIST_INSTRUCTIONS','This is a list of all users on the system. Non-equipment managers will have a Guest icon, equipment managers will have Reception/Equipment Manager/Super equipment manager icons.<br/>When Jomres is first installed "admin" is automatically added as a equipment manager and is considered an authorised user.<br/>Non-super equipment managers must be assigned to at least one equipment otherwise they will see an error when they try to log on and use Jomres.<br/>Once a user is authorised then you can edit their profiles, assign them to equipments or give them super equipment manager rights.<br/>To authorise a user, click on the red Cross next to their name. To unauthrorise them, click the green Tick.<br/>To assign users to specific equipments only, or give them super equipment manager rights, authorise them then click the edit icon (which is only visible once they\'ve been authorised). Users who\'ve registered their equipment(s) themselves will be automatically assigned to those equipments. Super equipment managers automatically have rights over all equipments, and will see all configuration options even if the minimised configuration option is set in Site Config.');
define('_JOMRES_PROFILEEDIT_INSTRUCTIONS','Here you can assign a manager to certain equipments. Ensure, if they\'re not going to be a super equipment manager, that they have rights to at least one equipment otherwise they will see an error when they log in. To give a receptionist/equipment manager rights over only certain equipments, ensure that the Super Equipment Manager dropdown is not set to Yes.');
define('_JOMCOMP_MYUSER_VIEWBOOKINGS_NONE','You haven\'t made any rentals yet!');
define('_JOMRES_COM_MR_VRCT_PROPERTY_TYPE_TAB','Equipment type');
define('_JOMRES_COM_MR_VRCT_PROPERTY_TYPE','Edit your equipment type');
define('_JOMRES_COM_MR_VRCT_PROPERTY_TYPE_INFO','Select your equipment type');
define('_JOMRES_COM_LOGGING','Jomres logging');
define('_JOMRES_COM_LOGGING_WARNING','These options allow you to enable/disable logging within Jomres. Error logging is always enabled, but other logs such as Rental, Gateway, System and Request logs can be switched on and off. You are advised that <b>the ability to enable this logging is provided purely as a way of making debugging easier but it rentalries a big security risk</b> as it is easy for outside users to view your logs without being authorised therefore you are advised to leave it switched off most of the time. If you have enabled logging, then when you have disabled it, you should also ensure that the <i>'.JOMRESPATH_BASE.JRDS.'temp'.JRDS.'</i> folder does not contain any old log files. Note that enabling logging will also significantly slow your sytem down as it collects a lot of information.');
...
define('_JOMRES_COM_A_BOOKINGFORM_SHOWROOMTYPEIMAGE','Rental form equipment list show equipment type image');
define('_JOMRES_COM_A_LISTLIMIT','Equipment List limit');
define('_JOMRES_COM_A_LISTLIMIT_DESC','The number of equipments to show on a page after a search');
define('_JOMRES_COM_A_INTEGRATEDSEARCH_TITLE','Integrated search feature');
define('_JOMRES_COM_A_INTEGRATEDSEARCH_TITLE_DESC','The Jomres integrated search feature allows your users to search through Jomres equipments according to a set of functions. If you have already used the search features of Jomres in Joomla you will be familiar with these settings.<br/>This feature allows us to offer search handling within Jomres for those users who don\'t want to use Joomla search modules, or for other CMS users who\'s CMS doesn\'t have it\'s own Jomres search modules.<br/>Just remember that if you choose to search for something via a link (ie not a dropdown) then other search options will not be implemented, only the element that corresponds with the link that you clicked.<br/>Note that by default the layout of this integrated search isn\'t very pretty. That\'s because the template file that performs the layout has to include all possible options, some of which are incompatible. To improve the layout and achieve the look you desire, you will need to edit <b>srch.html</b> in the folder <b>'.JOMRES_TEMPLATEPATH_FRONTEND.'</b> ');
define('_JOMRES_COM_A_INTEGRATEDSEARCH_ENABLE','Activate this feature?');
define('_JOMRES_COM_A_INTEGRATEDSEARCH_ENABLE_DESC','If this feature is enabled, then any call to Jomres that shows the equipment list will mean that the search options are also shown.');
...
define('_JOMRES_COM_A_INTEGRATEDSEARCH_PROPERTYNAME',"Search by equipment name");
define('_JOMRES_COM_A_INTEGRATEDSEARCH_PROPERTYNAME_DESC',"Show the search by equipment name input.");
...
define('_JOMRES_COM_A_INTEGRATEDSEARCH_PROPERTYTYPE',"Search by equipment type");
define('_JOMRES_COM_A_INTEGRATEDSEARCH_PROPERTYTYPE_DESC',"Show the search by equipment type input");
...
define('_JOMRES_COM_A_INTEGRATEDSEARCH_ROOMTYPE',"Search by equipment type");
define('_JOMRES_COM_A_INTEGRATEDSEARCH_ROOMTYPE_DESC',"Show the search by equipment type input");
...
define('_JOMRES_COM_A_INTEGRATEDSEARCH_RANGEINCREMENTS_DESC',"Jomres will look at all the values in the fees then work out a series of price ranges based on the increments value you set here.");
define('_JOMRES_A_GLOBAL_SEARCHOPTION_RANDOMLIMIT_DESC','By default, if a equipment is not selected in Jomres it will perform a search. If this search was not triggered by a search module then that search will produce random results (deliberately). This option allows you to limit the number of returns in that random search.');
...
define('_JOMRES_COM_TEMPLATEEDITING_DESC','This functionality allows us to edit Jomres frontend templates on the server, saving the results to the database. Advanced feature, be rentaleful with it.');
...
define('_JRPORTAL_COUPONS_ROOMONLY',"Equipment only");
define('_JRPORTAL_COUPONS_ROOMONLY_DESC',"Discount is only applied to the cost of the equipment. If No, then the discount is applied to the entire cost of the rental.");
...
<br/>
");
define('_JOMRES_COM_A_BOOKINGFORM_SHOWDISABLED','Rental form equipment list show disabled access');
define('_JOMRES_COM_A_BOOKINGFORM_SHOWMAXPEOPLE','Rental form equipment list show max people');
define('_JRPORTAL_HORIZROOMSLIST_ESTIMATEWARNING',"Please note that rental prices listed are estimates and the full price of the rental will not be calculated until you have added a equipment or equipments to your selection.");
...
define('_JRPORTAL_SUBSCRIPTIONS_PACKAGES_ROOMSLIMIT',"rentals limit"); // Not currently used, saved for a rainy day
define('_JRPORTAL_SUBSCRIPTIONS_PACKAGES_PROPERTYLIMIT',"rental limit");
...
define('_JRPORTAL_SUBSCRIBERS_AVAILABLE_PROPERTIES1',"You need a valid subscription to create new equipments. At this moment in time, you have purchased subscriptions for ");
define('_JRPORTAL_SUBSCRIBERS_AVAILABLE_PROPERTIES2'," <i>published</i> equipment(s). ");
define('_JRPORTAL_SUBSCRIBERS_AVAILABLE_PROPERTIES3',"You can increase the number of equipments you can create by <a href='".JOMRES_SITEPAGE_URL."&task=list_subscription_packages'>purchasing more subscription packages here.</a>");
define('_JRPORTAL_SUBSCRIBERS_AVAILABLE_PROPERTIES4'," You have used ");
define('_JRPORTAL_SUBSCRIBERS_AVAILABLE_PROPERTIES5'," equipment slots. ");
define('_JRPORTAL_SUBSCRIBERS_AVAILABLE_PROPERTIES6',"To see a list of your current equipments click <a href='".JOMRES_SITEPAGE_URL."&task=listyourequipments'>here</a>. ");
...
define('_JRPORTAL_SUBSCRIPTIONS_PUBLISHERROR',"Unfortunately, you cannot publish this equipment as you have reached your maximum number of available equipment slots.");
define('_JRPORTAL_SUBSCRIBERS_SUBSCRIBED',"Thank you for creating a subscription to list your equipment on our server. Once your invoice is marked as paid (there may be a delay depending on Paypal) please <a href='".JOMRES_SITEPAGE_URL."&task=registerProp_step1'>click here to continue creating your equipment(s).</a>");
...
define('_JRPORTAL_SUBSCRIBERS_CANNOT_PUBLISH',"We are sorry, but you've met the limit of the number of equipments that you can have published on this system at any one time. You can raise the number of equipments that you can publish by <a href='".JOMRES_SITEPAGE_URL."&task=list_subscription_packages&Itemid=".$Itemid."'>purchasing more subscription packages here.</a> ");
...
define('_JOMRES_CLICKTOREGISTER','Click here to register your equipment');
...
define('_JOMRES_USER_LISTMYPROPERTY','Add my equipment to this site');
...
define('_JOMRES_COM_YOURBUSINESS','Your equipment details');
define('_JOMRES_COM_YOURBUSINESS_NAME','equipment name');
...
<br/> 
If the equipment has one or more rentals for the period selected, then you will not be able to rent it out until the other rentals/black rentals, have been cancelled/rented out.');
define('_JOMRES_FRONT_BLACKBOOKING_SRP_CANNOTBLACKBOOK','Sorry, you cannot black rent this equipment for those dates.');
define('_JOMRES_FRONT_BLACKBOOKING_SRP_CANBLACKBOOK','You can blackrent this equipment for those dates.');
define('_JOMRES_WARNINGS_PERPERSONPERNIGHT_NOGUESTTYPES','Your equipment is configured to charge per person per night but you do not have any guest types created or published, please create and publish one or more guest types. ');
define('_JOMRES_WARNINGS_TARIFFS_NOTARIFFS','You don\'t have any fees configured yet, you will not be able take any rentals for your equipment');
...
define('_JOMRES_CONTACTOWNER_TO_ADMIN_DESC','Set this option to Yes if you want Contact Owner emails to be sent to the below input. Leave it set to No to send the emails to the email address defined in the equipment configuration area.');
...
define('_JOMRES_REALESTATE_YESNO','Is this equipment a for sale listing?');
define('_JOMRES_REALESTATE_YESNO_DESC','Select Yes if you are selling the equipment, select No if it is a listing where you will be offering short term rentals and will be using this system for taking rentals.');
...
define('_JOMRES_ADMIN_REGISTRATION_LIMITPROPERTY_YESNO','Limit equipment registration to one country?');
define('_JOMRES_ADMIN_REGISTRATION_LIMITPROPERTY_YESNO_DESC','You can ensure that equipment registrations are limited to just one country by setting this option to Yes and setting the country in the following option.');
define('_JOMRES_ADMIN_REGISTRATION_LIMITPROPERTY_COUNTRY','Equipments are located in this country : ');
define('_JOMRES_JQUERYTHEME','Jquery theme');
define('_JOMRES_JQUERYTHEME_DESC','Choose a jquery theme to use for the equipment details tabs.');
define('_JOMRES_PROPERTYNOTOUBLISHED','We are sorry, but that equipment is not currently available.');
define('_JOMRES_REVIEWS','Reviews');
define('_JOMRES_REVIEWS_TITLE','Review title');
define('_JOMRES_REVIEWS_DATE','posted on ');
define('_JOMRES_REVIEWS_NOREVIEWS','There are no reviews for this equipment yet.');
define('_JOMRES_REVIEWS_NOREVIEWS_BETHEFIRST','Would you like to be the first to review this equipment?');
...
define('_JOMRES_REVIEWS_REVIEWBODY','Tell us what you think about this equipment : ');
...
define('_JOMRES_REVIEWS_ALREADYREVIEWED','You have already reviewed this equipment, you can\'t post another review about it.');
...
define('_JOMRES_REVIEWS_ADDREVIEW_ERROR_PROS','Please enter the good parts of your experience of being a guest at this equipment');
...
define('_JOMRES_REVIEWS_ADDREVIEW_ERROR_RATING_2','Please rate your opinion of the equipment\s locale');
define('_JOMRES_REVIEWS_ADDREVIEW_ERROR_RATING_3','Please provide your opinion of the cleanliness of the equipment');
...
define('_JOMRES_REVIEWS_ADMIN_TESTMODE_DESC','Normally equipment managers cannot review equipments. With test mode enabled, they can. Naturally this is not ideal in a production environment.');
define('_JOMRES_REVIEWS_ADMIN_PROPERTYLISTINFO','This is a list of all equipments. To see a equipment\'s reviews, click on that equipment. From there you will be able to publish or delete a review.');
...
define('_JOMRES_COM_A_SHOWBOOKINGFORMINPROPERTYDETAILS','Show Rental form in equipment details page?');
define('_JOMRES_COM_A_SHOWBOOKINGFORMINPROPERTYDETAILS_DESC','Set this to Yes to show the rental form in the equipment details page. If you set it to No, then a link will appear in the equipment details page instead pointing to the rental form.');
define('_JOMRES_COM_A_TAXINCLUSIVE','Fees are gross?');
...
define('_JOMRES_ROOMALLOCATIONS_ROOM','Equipment ');
define('_JOMRES_ROOMALLOCATIONS_GUESTS','guest(s). ');
define('_JOMRES_ROOMALLOCATIONS_INFORMATION','This how we have assigned your guest numbers to their equipments. If you would like to change this allocation, you will need to contact the hotel after making the rental. Extra charges may apply if you change your assignments.');
define('_JOMRES_SANITY_CHECK_NOT_PUBLISHED','Note that your equipment is  not yet published, only you can see the equipment, site visitors will not see it <a href="http://jumpers.bestworldsweb.com/component/jomres/?Itemid=472&no_html=1&task=publishProperty&jomrestoken=xxx">click here to publish</a>');
...
define('_JOMRES_ROOMMSLIST_STYLE','Equipments list style');
define('_JOMRES_ROOMMSLIST_STYLE_DESC','In the rental form, using the "classic" equipments list style you offer individual equipments to guests. With the equipment type view, guests choose the number of equipments of type X (eg. 2 x doubles) instead');
define('_JOMRES_ROOMMSLIST_STYLE_CLASSIC','Classic');
define('_JOMRES_ROOMMSLIST_STYLE_ROOMTYPES','Equipment types');
define('_JOMRES_BOOKINGFORM_PROGRESSMESSAGE_START','(Re)checking availability');
define('_JOMRES_BOOKINGFORM_PROGRESSMESSAGE_REBUILDING_AVAILABLEROOMS','Rebuilding available equipments list');
...
define('_JOMRES_REVIEWS_ADMIN_GUESTSONLY','Only Equipment guests can review?');
define('_JOMRES_REVIEWS_ADMIN_GUESTSONLY_DESC','Set this to Yes if you want to restrict reviews to only those users who have been a guest already in this equipment.');
define('_JOMRES_CUSTOMTEXT_EXTRAMODEL_PERROOMPERBOOKING','Per equipment');

define('_JOMRES_MAX_GUESTS_PER_ROOM','Guests per equipment : ');
define('_JOMRES_MAX_GUESTS_PER_BOOKING','Guests per rental : ');
define('_JOMRES_NUMBER_OF_ROOMS','Number of equipments');

define('_JOMRES_MICROMANAGE_TARIFFDEFAULT','fee default price');
define('_JOMRES_MICROMANAGE_TARIFFDEFAULT_DESC',"This only applies to new fees");
define('_JOMRES_MICROMANAGE_YEARSTOSHOW',"Years to show");
define('_JOMRES_MICROMANAGE_YEARSTOSHOW_DESC',"Defines the number of years to show when editing a micromanage fee");
...
define('_JOMRES_PROPERTYMANAGEMENTPROCESS',"Equipment management process");
define('_JOMRES_PROPERTYMANAGEMENTPROCESS_DESC',"There are different management processes depending on the way you want to list your equipment.");
define('_JOMRES_PROPERTYMANAGEMENTPROCESS_RENTAL',"Rental");
define('_JOMRES_PROPERTYMANAGEMENTPROCESS_RENTAL_DESC',"Choose the rental option if you are rental out equipments in a equipment (eg. Hotel/B&B/Villa/Apartment)");
define('_JOMRES_PROPERTYMANAGEMENTPROCESS_REALESTATE',"Realestate/simple listing");
define('_JOMRES_PROPERTYMANAGEMENTPROCESS_REALESTATE_DESC',"Choose the real estate option if you are not offering any rental functionality at all, (eg. A equipment/item for sale)");

define('JOMRES_COM_A_MINIMALCONFIG_DESC','Set this to Yes to reduce the number of options available to equipment managers in the General Configuration section. This is useful if you do not want equipment managers to play around with too many settings, instead you can edit jomres_config.php to define default equipment options.');
define('_JOMRES_AJAXFORM_EXTRAS_SELECT','Please select an option for your rental');
define('_JOMRES_COM_ALLOWHTMLEDITOR_DESC','Switches on html editors in equipment details editing page. Additionally, if this is set to No, then all html except p and br is stripped from all entered and displayed text.');
define('_JOMRES_COM_MANAGEMENTVIEW_MANAGMENT',"Fullscreen view");
define('_JOMRES_COM_MANAGEMENTVIEW_SITEPREVIEW',"Normal view");
define('_JOMRES_COM_TIMEZONE_SWITCHER',"Show the timezone switcher in the equipment manager's toolbar?");

define('_JOMRES_PARTNER_DISCOUNT',"Partner discount ");
define('_JOMRES_PARTNER_CHOOSE_SEARCHTITLE',"Search user");
define('_JOMRES_PARTNER_CHOOSE_SEARCH_INSTRUCTIONS',"Enter a few characters to search for a user.<br/> When you select a user you will automatically add them as a Partner and you will be taken to the next page where you can assign equipments and discounts to the user.");
...
define('_JOMRES_PARTNER_SHOW_SEARCHTITLE',"Search for a equipment");
define('_JOMRES_PARTNER_SHOW_SEARCHINSTRUCTIONS',"Enter a few characters from the equipment name and select a equipment.<br/> When you select the equipment you will add it to the partner's portfolio, however they will not yet enjoy any discounts, you will need to set those youself.");
define('_JOMRES_PARTNER_SHOW_CURRENTPROPERTIES',"Current equipments");
define('_JOMRES_PARTNER_SHOW_CURRENTPROPERTIES_INSTRUCTIONS',"Click on a equipment to edit the partner's discount settings for that equipment.");

// 4.6
define('_JOMRES_SUSPENSIONS_TITLE',"Suspended? <br/>(click to suspend a manager, this will auto-unpublish all of their equipments ) ");
define('_JOMRES_SUSPENSIONS_MANAGERLIST_INFO',"Click on the Suspend Icon (the icon with the man and the green tick) to suspend a manager. This means that the manager will not be able to perform equipment management functions and all of their equipments will be unpublished. Super equipment managers cannot be suspended.");
...
define('_JOMRES_SUSPENSIONS_MANAGER_SUSPENDED_EMAIL',"Please note that your equipment manager account has been suspended. You will not be able to perform any equipment management functions until the account has been restored.");
define('_JOMRES_SUSPENSIONS_MANAGER_UNSUSPENDED_EMAIL',"Please note that your equipment manager account is now active. You may continue to perform any equipment management functions. Please log into your account and ensure that the approprite propert(ies) have been published. Thank you.");
...
define('_JOMRES_MANAGER_CHOOSE_SEARCH_INSTRUCTIONS',"Enter a few characters from their username to search for a user.<br/> When you select a user you will automatically add them as a Manager and you will be taken to the next page where you can assign equipments and access rights to the user.");
...
define('_JOMRES_CHOOSEMANAGER_NUMBEROFPROPERTIES_ASSIGNED',"Number of equipments");
...
define('_JOMRES_COM_THUMBNAIL_SMALL_WIDTH_DESC','Small thumbnails are used in the equipment list whereas medium sized thumbnails are used in the equipment header.');
...
define('_JRPORTAL_INVOICES_COMMISSION_AUTOSUSPEND_THREASHOLD_DESC',"This threashold is the number of days that a manager has to pay an invoice before they are suspended and their equipments unpublished.");
...
define('_JOMRES_BOOKINGORM_ROOMTOTAL_EX_TAX','Rental');
define('_JOMRES_BOOKINGORM_ROOMTOTAL_INC_TAX','Accomodation inc tax');
define('_JOMRES_AJAXFORM_BILLING_TAX_ACCOM','Tax');
...
define('_JOMRES_BOOKINGORM_ROOMFEATURE_FILTER','Filter equipments based on their features.');
...
define('_JOMRES_COM_A_TARIFFS_PER_DESC_WHOLEDAY','Select Yes if you want to charge per-person-per-day. If no, then costs will be calculated on a per-equipment-per-day basis');
...
define('_JOMCOMP_WISEPRICE_TITLE_DESC_FULL_WHOLEDAY','Most equipments will recalculate equipment prices based on the number of rentals of a required type that are available on a given date. This allows them to offer discounts on a equipment type that isn\'t busy during a given period with the aim of attracting equipment that might otherwise be missed.<br/>Enabling and configuring this plugin allows you to offer adjustable pricing based on the number of equipments of a selected type are available in the equipment on a given day.<br/> The days threshold defines the number of days that the pickup date must be within before equipment prices are adjusted by this feature, then the percentages options allow you to configure the percentage of equipments that can be available before a given discount is applied. Note however, if multiple equipments are rented then the current level of discount will be applied to all equipments and will not reduce as more equipments are selected.');
...
define('_JOMRES_FEATURE_PROPERTY_TYPE_ASSIGNMENT','Equipment types that can show this feature');
define('_JOMRES_CRATES_CLICKINITIAL','Click on a letter to show all equipments with that first character. Once you have a list of properties you can assign commission rates to those properties, or click on their "edit" icon to view the equipment\'s statistics.');
...
define('_JOMRES_MYPROPERTIES','My equipments');
